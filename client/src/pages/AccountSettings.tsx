...
export default function AccountSettings() {
    ...
    const handleUpdateProfile = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errMsg = error instanceof Error && 'response' in error
                ? (error as any).response?.data?.message || 'Không thể cập nhật thông tin'
    ...
    const handleChangePassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errMsg = error instanceof Error && 'response' in error
                ? (error as any).response?.data?.message || 'Không thể đổi mật khẩu'
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow py-8 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    {/* Thông tin cá nhân */}
                    <div className="bg-white dark:bg-[var(--card)] rounded-lg shadow-lg p-6 mb-6">
                        ...
                        <form onSubmit={handleUpdateProfile} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-lg transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                            >
                                <FaSave size={20} />
                    ...
                    <div className="bg-white dark:bg-[var(--card)] rounded-lg shadow-lg p-6">
                        ...
                        <form onSubmit={handleChangePassword} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white font-bold py-3 px-6 rounded-lg transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
                            >
                                <FaLock size={20} />
